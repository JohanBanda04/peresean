...
<!--                    <li class="has-sub --><?php //if($menu=='harmonisasi' OR ($menu=='harmonisasi' AND $sub_menu=='v') OR ($menu=='folder_data_dukung' AND $sub_menu=='v') OR ($menu=='data_dukung' AND $sub_menu=='v') OR ($menu=='rpd' AND $sub_menu=='v') OR ($menu=='ankabut' AND $sub_menu=='v')){echo " active";} ?><!--">-->
                    ...
                    if(
                        ...
                        <ul class="sub-menu">
                            <li <?php if($menu=='harmonisasi' and $sub_menu=='v' and $sub_menu3=='pemprov_ntb'){ echo " class='active'"; } ?>>
                            ...
                            <li <?php if($menu=='harmonisasi' AND $sub_menu=='v' and $sub_menu3=='pemkab_lombok_utara'){echo " class='active'";} ?>>
                                <a href="harmonisasi/v/pemkab_lombok_utara.html">
                                    <i class="fa fa-file-text"></i> <span>Pemkab Lombok Utara</span>
                                </a>
                            </li>
                            <li <?php if($menu=='harmonisasi' AND $sub_menu=='v' and $sub_menu3=='pemkab_lombok_timur'){echo " class='active'";} ?>>
                                <a href="harmonisasi/v/pemkab_lombok_timur.html">
                                    <i class="fa fa-file-text"></i> <span>Pemkab Lombok Timur</span>
                                </a>
                            </li>
                            <li <?php if($menu=='harmonisasi' AND $sub_menu=='v' and $sub_menu3=='pemkab_lombok_tengah'){echo " class='active'";} ?>>
                                <a href="harmonisasi/v/pemkab_lombok_tengah.html">
                                    <i class="fa fa-file-text"></i> <span>Pemkab Lombok Tengah</span>
                                </a>
                            </li>
                            <li <?php if($menu=='harmonisasi' and $sub_menu=='v' and $sub_menu3=='pemkab_lombok_barat'){echo " class='active'";} ?>>
                            ...
                            <li <?php if($menu=='harmonisasi' AND $sub_menu=='v' and $sub_menu3=='pemkab_dompu'){echo " class='active'";} ?>>
                                <a href="harmonisasi/v/pemkab_dompu.html">
                                    <i class="fa fa-file-text"></i> <span>Pemkab Dompu</span>
                                </a>
                            </li>
                            <li <?php if($menu=='harmonisasi' AND $sub_menu=='v' and $sub_menu3=='pemkab_bima'){echo " class='active'";} ?>>
